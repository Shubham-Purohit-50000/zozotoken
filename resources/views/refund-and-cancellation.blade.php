...
<div class="container">
   ...
   <div class="header">
      <div class="container">
         <p class="title">Return and Cancellation Policy for zozotoken</p>
      </div>
   </div>
   <div class="translations-content-container">
      <div class="container">
         <div class="tab-content translations-content-item en visible" id="en">
            ...
            <p>Thank you for shopping at zozotoken.</p>
            ...
            <ul>
               <li>
                  <p><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to zozotoken.</p>
               </li>
               <li>
               ...
               <li>
                  <p><strong>Website</strong> refers to zozotoken, accessible from <a href="https://zozotoken.com" rel="external nofollow noopener" target="_blank">https://zozotoken.com</a></p>
               </li>
               <li>
            ...
            <ul>
               <li>
                  <p>By email: zozotokenhelp@gmail.com</p>
               </li>
               <li>
                  <p>By phone number: 9004539476</p>
               </li>
            </ul>
            ...
            <p>Ajad nagar, back side of sunder wan, nawalgarh road, sikar, Rajasthan 332001</p>
